...
#line = [(244,200), (1050, 200)]
#line = [(244,440), (1050, 456)]
#line = [(468,570), (1500, 570)]
#line = [(514,637), (1413,641)]
line = [(17,628), (1868,639)]
...
#objct_counter1={'car':14, truck:'10', motorcycle:'13'}
#object_counter1 = {}
        """keys = ['car', 'truck', 'motorcycle']
        sum = 0
        for key in keys:
            if key in object_counter1:
                sum += object_counter1[key]

        if sum > 5:
            print("Traffic Jammed")
            break"""
   

                #if object_counter1[obj_name] > 5:
                 #   print("Traffic jammed")
        ...
        """for idx, (key, value) in enumerate(object_counter1.items()):
            ...
            cv2.putText(img, f'Number of Vehicles Entering', (width - 500, 35), 0, 1, [225, 255, 255], thickness=2,
                        lineType=cv2.LINE_AA)
            cv2.line(img, (width - 1400, 65 + (idx * 40)), (width - 500, 65 + (idx * 40)), [85, 45, 255], 30)
            cv2.putText(img, cnt_str, (width - 150, 75 + (idx * 40)), 0, 1, [255, 255, 255], thickness=2,
                        lineType=cv2.LINE_AA)"""
...
if __name__ == '__main__':
    ...
    keys = ['car', 'truck', 'motorcycle', 'bus']
    sum = 0
    for key in keys:
        if key in object_counter:
            sum += object_counter[key]
    print(sum)
    ...
    if sum >= 10:
        ...
        print("**              THANK YOU!!!                **")
        print("**                                          **")
        print("**   Vehicle count at next signal: ", sum,"     **")
        print("**                                          **")
        print("**********************************************")
        print("**********************************************")
